...
zokou({
  ...
  async function redeployApp() {
    try {
      ...
      await repondre("*Your bot is getting updated, wait 2 minutes for the redeploy to finish! This will install the latest version of XGAGA BOT.*");
